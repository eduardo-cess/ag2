...
ag_class.prototype.play_ag = function(tipo_ag){
	var tipo = '';
...
ag_class.prototype.reproduzir = function(tipo_ag){
	var soma_aptidao = 0;
...
ag_class.prototype.cruzamento = function(){
	var ponto_corte = m.randomInt(50);//ponto de corte aleatorio
	var filho;
	filho = this.pais[0].slice(0,ponto_corte)+this.pais[1].slice(ponto_corte,50);
	this.filhos.push(String(filho).replace(/,/g , ""));
	filho = '';
	filho = this.pais[1].slice(0,ponto_corte)+this.pais[0].slice(ponto_corte,50);
	this.filhos.push(String(filho).replace(/,/g , ""));
	filho = '';
	this.pais = [];
}
